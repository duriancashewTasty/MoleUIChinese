...
enum SidebarItem: String, CaseIterable, Identifiable {
    ...
    /// Localized display name for sidebar navigation
    var displayName: String {
        switch self {
        case .status: LanguageManager.tr("Status")
        case .diskAnalyzer: LanguageManager.tr("Disk Analyzer")
        case .clean: LanguageManager.tr("Clean")
        case .purge: LanguageManager.tr("Purge")
        case .installer: LanguageManager.tr("Installers")
        case .optimize: LanguageManager.tr("Optimize")
        case .uninstall: LanguageManager.tr("Uninstall")
        case .settings: LanguageManager.tr("Settings")
        }
    }
    ...
    var body: some View {
        HStack(alignment: .top, spacing: 20) {
            VStack(alignment: .leading, spacing: 12) {
                HStack(spacing: 8) {
                    Text(eyebrow.localizedUppercase)
