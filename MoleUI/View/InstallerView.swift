...
struct InstallerView: View {
    ...
    private var headerCard: some View {
        MoleHeroPanel(
            eyebrow: LanguageManager.tr("Files"),
            title: LanguageManager.tr("Installers"),
             subtitle: LanguageManager.tr("Find forgotten `.dmg`, `.pkg`, `.xip`, and archive downloads before they quietly eat your SSD."),
            ...
            VStack(alignment: .trailing, spacing: 10) {
                ...
                HStack(spacing: 10) {
                    MoleSearchField(prompt: LanguageManager.tr("Search installers"), text: $searchText)
                        .frame(width: 190)
    ...
    private var contentArea: some View {
            ...
            GroupBox {
                VStack(spacing: 8) {
                    ProgressView("Scanning for installers...")
                        .controlSize(.regular)
                    Text(LanguageManager.tr("Checking Downloads, Desktop, iCloud and more"))
                        .font(.caption)
        ...
        if service.files.isEmpty, !service.isScanning {
            GroupBox {
                Text(LanguageManager.tr("No installer files found."))
                    .foregroundStyle(.secondary)
                    .frame(maxWidth: .infinity)
                    .padding(.vertical, 24)
            }
        ...
        return GroupBox {
            HStack(spacing: 10) {
                ...
                if isDeleting {
                    ...
                    Button(LanguageManager.tr("Trash")) {
