    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            VStack(alignment: .leading, spacing: 16) {
                ...
                sidebarSection(LanguageManager.tr("Monitor"), items: [.status, .diskAnalyzer])
                sidebarSection(LanguageManager.tr("Cleanup"), items: [.clean, .purge, .installer, .optimize, .uninstall])
                sidebarSection(LanguageManager.tr("App"), items: [.settings])
            }
    ...
    private var brandHeader: some View {
        HStack(alignment: .center, spacing: 10) {
            ...
            VStack(alignment: .leading, spacing: 2) {
                ...
                Text(LanguageManager.tr("System care for macOS"))
