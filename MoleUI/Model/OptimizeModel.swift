...
final class OptimizeModel {
    ...
    func loadReport() async {
        ...
        do {
            ...
            guard let data = output.data(using: .utf8) else {
                errorMessage = LanguageManager.tr("Failed to read health report output")
                return
            }
    ...
    func runOptimize(dryRun: Bool = false) async {
        ...
        do {
            ...
            if dryRun {
                ...
                currentTask = LanguageManager.tr("Requesting administrator privileges...")
    ...
    private func parseCompleteOutput(_ output: String) {
        ...
        if currentTask != nil {
            currentTask = LanguageManager.tr("Optimization completed")
        }
    }
}
